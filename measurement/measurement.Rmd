...
Lorsque nous considérons le design d'une expérience, nous avons tendance à nous concentrer sur le processus par lequel le traitement $Z$ est assigné de manière aléatoire et la distribution conjointe de $Z$ et du résultat $Y$.
...
# 3. La mesure des traitements comprend l'opérationnalisation du traitement ainsi que le respect de l'assignation au traitement.
...
Lors de la représentation graphique de la corrélation entre mesure seule et variable latente (sur l'axe des $x$) par rapport à la corrélation entre indice et variable latente (sur l'axe des $y$), presque tous les points sont au-dessus de la ligne à 45 degrés.
