...
data.frame(measures = c(sims["cor_Y1",], sims["cor_Y2",]),
  ...
  scale_y_continuous("Correlación entre la medición y la variable latente", limits = c(0.1, .6)) + 
  theme_minimal()
```
