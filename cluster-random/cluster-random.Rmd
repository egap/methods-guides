...
En fin de compte, il faudrait combiner des schémas de randomisation avec grappe et sans grappe afin d'estimer les effets du débordement intra-grappe, $Y_{11} - Y_{01}$ et $Y_{01} - Y_{00}$.
...
Souvent, ces approches utilisent des "modèles à plusieurs niveaux", dans lesquels des paramètres inconnus - tels que les différences intra-grappe - sont eux-mêmes compris comme résultant de distributions de probabilité.
