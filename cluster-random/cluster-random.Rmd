...
Cependant, dans la seconde version, la procédure de randomisation assigne tous les sujets aux cheveux noirs soit à un traitement, soit à un contrôle, et ne produit donc jamais que deux façons de combiner les personnes pour estimer un effet.
