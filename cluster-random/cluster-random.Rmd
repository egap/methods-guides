...
#2 Pourquoi le découpage par grappe peut être important I : réduction de l'information
...
le découpage par grappe réduit le plus l'information lorsqu'il
...
Dans cette section, nous nous limitons aux approches dites "basées sur le design" pour le calcul de l'erreur type.
...
Le RCSE est légèrement plus prudent que la véritable erreur type dans ce cas, mais il est très proche.
L'écart est probablement dû au fait que le RCSE n'est pas une bonne approximation de la véritable erreur type lorsque le nombre de grappes est aussi petit qu'ici.
...
Comme l'illustrent ces exemples simples, le RCSE se rapproche de la vérité (l'erreur type simulée) à mesure que le nombre de grappes augmente.
Pendant ce temps, l'erreur type ignorant le découpage par grappe (en supposant l'IID) a tendance à être plus petite que l'une ou l'autre des autres erreurs types.
...
Ainsi, l'appariement de paires promet non seulement de réduire les biais, mais peut également grandement atténuer le problème de réduction de l'information induit par le découpage par grappe.
