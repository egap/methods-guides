...
Nous appellerons cela l'erreur standard IID.
...
Pour illustrer davantage ce point, nous pouvons comparer une simulation de la véritable erreur standard générée par des permutations aléatoires du traitement aux erreurs standard IID et RCSE.
...
Comme l'illustrent ces exemples simples, le RCSE se rapproche de la vérité (l'erreur standard simulée) à mesure que le nombre de grappes augmente.
...
en espérance, l'estimateur par paire converge vers le véritable effet moyen du traitement pour l'échantillon,
