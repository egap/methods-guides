...
typically want to calculate a standard error:
 an estimate of how much the treatment effect 
*would have* varied, were we able to repeat the experiment a very large 
number of times and observe units alternatively in their treated and untreated states. 
...
calculating standard errors do not take into account clustering, which, as
we noted above, can strongly increase the amount estimates vary from one 
repetition of the experiment to another. 
...
approaches to calculating the standard. 
