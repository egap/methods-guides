...
Il s'agit d'un design par grappe car, bien que le traitement soit assigné au village dans son ensemble, nous nous intéressons aux résultats définis au niveau du ménage.
...
Étant donné que l'unité d'assignation du message est le ménage, mais que le résultat est défini comme un comportement individuel, cette étude est randomisée par grappe.
