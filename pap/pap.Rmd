...
[^DD]: Resources like the DeclareDesign project can assist you with simulating and analyzing fake data that mimics the real data your project will gather.  [Power analysis](http://egap.org/resource/10-things-to-know-about-statistical-power), an important component of a PAP, requires simulated data.
