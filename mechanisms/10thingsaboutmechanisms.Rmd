...
**Ce que vous pouvez faire...** Dans les projets futurs, posez-vous la question : mon traitement peut-il être "décomposé" en plusieurs bras de traitement, certains qui manipulent implicitement M, et d'autres non ? Envisagez d'utiliser un design factoriel pour identifier les effets des différents bras de traitement.
