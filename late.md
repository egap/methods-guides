...
set.seed(1) 
Z T Y # Share of compliers = 0.8. 
lm(T~Z) 
# ITT = 0.403 
lm(Y~Z) # LATE = ITT/ share of compliers = 0.504 
0.403/0.8 
library(AER) 
# Estimate 2SLS = 0.504 
summary(ivreg(Y~T | Z)) 
