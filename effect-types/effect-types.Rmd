...
Plus précisément, le package produit des estimateurs de l'ATE par régression, par pondération IPW (inverse-propensity weighting) et par pondération IPW augmentée.
...
Lorsque le traitement est assigné au hasard et que la conformité est totale, $ATE=ATT=ATC$, puisque $E(Y_i(0)∣D_i=1)=E(Y_i(0)∣D_i=0)$ et $E( Y_i(1)∣D_i=0)=E(Y_i(1)∣D_i=1)$.
