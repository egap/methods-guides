...
Power is the overall probability that your design will detect an effect if an effect exists. Calculating [power](http://egap.org/methods-guides/10-things-you-need-know-about-statistical-power) involves making assumptions about the range of possible effect sizes, the range of possible values of predictive covariates, how many subjects you will include in your experiment, and how many subjects will answer your survey. Developing your instrument and sampling procedure can significantly improve the accuracy of these assumptions by setting the range of possible values for covariates and outcome measures. 
...
The [survey implementation](http://egap.org/content/10-things-know-about-survey-implementation) guide explains about how to set up and carry out a pre-test. 
