...
The [survey implementation](http://egap.org/content/10-things-to-know-about-survey-implementation) guide explains about how to set up and carry out a pre-test. 
