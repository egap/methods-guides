...
```{r thebarplot, echo = FALSE,message=F, error=F,warning=F, fig.width=6, fig.height=3, fig.align ="center",fig.cap="Sample average incomes calculated for all 15 possible samples of 4 units from a population of 6 units. The blue dotted line shows the true average income in the population."}
