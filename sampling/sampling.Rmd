...
```{r samplingdistributions, echo = FALSE,message=F, error=F,warning=F, fig.width=6, fig.height=5, fig.align ="center", ,fig.cap="Distributions of true effects and effect estimates that take into account variation from sampling, from random assignment or both in a hypothetical experiment that randomly samples 4 units from a population of 6 units. The blue dotted line shows the mean of the respective distribution."}
