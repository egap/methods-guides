...
If subjects receive different probabilities of assignment to treatment based on their covariates, then our estimation method needs to account for this (again, see [10 Things You Need to Know About Randomization](http://egap.org/methods-guides/10-things-you-need-know-about-randomization) for details).
...
For further reading
==
Athey, Susan, and Guido W. Imbens (2016). "The Econometrics of Randomized Experiments." [arXiv](http://arxiv.org/abs/1607.00698)
...
Wager, Stefan, Wenfei Du, Jonathan Taylor, and Robert Tibshirani (2016). "High-Dimensional Regression Adjustments in Randomized Experiments." [arXiv](https://arxiv.org/abs/1607.06801)