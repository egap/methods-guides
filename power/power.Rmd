...
* Ensemble, les hypothèses sur μt et μc définissent notre hypothèse sur la taille de l'effet du traitement : 65-60= 5.
...
Cette formule suppose que chaque sujet a 50/50 de chances d'être dans le groupe de contrôle.
Supposons que $N=500$.
...
La randomisation par bloc est encore plus puissante : elle garantit qu'un certain nombre au sein d'un sous-groupe seront assignés au traitement.
