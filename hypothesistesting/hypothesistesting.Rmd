...
text(observedMeanTZ,.25,"Observed Test Statistic")
...
mtext(side=3,outer=TRUE,text=expression(paste("Distributions of Test Statistics for ",H0: y[i1]==y[i0])))
```
...
statistics less than the observed experiment. This one-tailed $p$-value 
