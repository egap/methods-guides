...
N <- 10
y0 <- c(0,0,0,1,1,3,4,5,50,60)
## Different individual level treatment effects
tau <- c(0,2,4,0,5,10,2,3,0,1)
...
rug(observedMeanTZ,lwd=3,ticksize = .6)
text(observedMeanTZ,.3,"Observed Test Statistic")

plot(density(possibleMeanRankDiffsH0),lwd=2,
     ylim=c(0,.45),
     xlim=range(possibleMeanDiffsH0),
     ##main="Mean Difference of Ranks Test Statistic",
     xlab="Mean Difference of Ranks")
rug(possibleMeanRankDiffsH0)
rug(observedMeanRankTZ,lwd=3,ticksize = .6)
text(observedMeanRankTZ,.3,"Observed Test Statistic")
```
...
statistics less than the observed experiment. This one-tailed $p$-value takes
is `r pMeanTZ` for the simple mean difference and `r pMeanRankTZ` for the mean
difference of the rank-transformed outcomes.
