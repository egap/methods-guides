...
Ce guide se concentre sur leur utilisation dans les expériences randomisées ou les designs de recherche qui tentent d'organiser les données
...
le fait qu'une expérience puisse détecter un effet de traitement dépend non seulement de la taille du pool expérimental, mais aussi de la distribution du résultat
...
La qunatité des preuves dont nous disposons sur une hypothèse dépend du design de l'étude.
