...
which returns a value of `r signif(meanrankTZ(y=Y,z=Z),2)`.
...
plot(density(possibleMeanDiffsH0),ylim=c(0,.45),lwd=2)
rug(possibleMeanDiffsH0)
lines(density(possibleMeanRankDiffsH0),lwd=2,col="gray",lty=2)
rug(possibleMeanRankDiffsH0,col="gray",line=-.1)
```
